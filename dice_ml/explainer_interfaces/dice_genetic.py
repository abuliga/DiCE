...
class DiceGenetic(ExplainerBase):
    ...
    def _generate_counterfactuals(self,query_instance,total_CFs,encoder,dataset, initialization="kdtree",
                                  ...
                                  sparsity_weight=0.2, diversity_weight=5.0, plausibility_weight=0.5, categorical_penalty=0.1,
                                  ...
                                  posthoc_sparsity_algorithm="binary", maxiterations=50, thresh=1e-2, verbose=False
                                  ,random_seed=None):
